secgrps:
  - name: gaies-pe-sit-common-scg
    ...
    rules:
      ...
      - ipProtocol: all
        fromPort: -1
        toPort: -1
        sourceGroupName: gaies-pe-sit-common-scg
    tags: {"Name": "gaies-pe-sit-common-scg", "vpc": "vpc-0ab445d0a2c633df4", "ManagedBy": "Salt", "Project": "gaies-pe", "DELETETHIS": "True"}

  - name: gaies-pe-sit-ecs-fargate-LoadBalancerSecurityGroup
    ...
    rules:
      ...
      - ipProtocol: all
        fromPort: -1
        toPort: -1
        sourceGroupName: gaies-pe-sit-LoadBalancerSecurityGroup
    tags: {"Name": "gaies-pe-sit-ecs-fargate-LoadBalancerSecurityGroup", "vpc": "vpc-0ab445d0a2c633df4", "Environment": "sit", "Project": "gaies-pe", "Manageby": "Salt", "Deletethis": "True"}
  ...
  - name: gaies-pe-uat-ecs-fargate-ContainerSecurityGroup
    ...
    tags: {"Name": "gaies-pe-uat-ecs-fargate-ContainerSecurityGroup", "Environment": "sit", "Project": "gaies-pe", "Manageby": "Salt", "Deletethis": "True" }
  ...
  - name: gaies-pe-common-scg-new
    ...
    tags: {"Name": "gaies-pe-common-scg-new", "Environment": "sit", "Project": "gaies-pe", "Manageby": "Salt", "Deletethis": "True" }